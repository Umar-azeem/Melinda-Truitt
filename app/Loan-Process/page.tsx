...
import {
  ...
  Scale,
  ScrollText,
  DollarSign,      // added for step 1
  Search,          // added for step 3
  Sparkles,        // added for step 4
} from "lucide-react";
...
export default function LoanProcessPage() {
  return (
    <div className="font-sans bg-white text-gray-800 overflow-x-hidden">
      {/* Hero Section */}
      <section className="relative bg-[#E46A52] text-white overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4">
                <Link
                  href="https://wa.me/14694804699"
                  className="inline-flex items-center justify-center gap-2 bg-white text-[#E46A52] px-5 py-2.5 sm:px-6 sm:py-3 rounded-xl font-semibold hover:bg-gray-100 transition-transform hover:-translate-y-1 shadow-lg text-sm sm:text-base"
                >
                  Apply Now
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6 text-center">
            <div className="p-4 sm:p-6 bg-white rounded-2xl shadow-sm">
              <div className="text-[#E46A52] text-2xl sm:text-3xl font-bold">
                30+
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {simpleSteps.map((step, index) => (
              <div
                key={index}
                className="bg-gray-50 rounded-2xl p-6 sm:p-8 border border-gray-100 hover:shadow-lg transition-shadow group"
              >
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 rounded-xl bg-[#E46A52]/10 text-[#E46A52] flex items-center justify-center flex-shrink-0 group-hover:bg-[#E46A52] group-hover:text-white transition-colors">
                    {step.icon}
                  </div>
                  <span className="text-sm font-bold text-[#E46A52]">Step {index + 1}</span>
                </div>
      ...
      {/* Process Steps - Visual Timeline (existing) */}
      <section className="py-12 sm:py-16 md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-gray-800">
              Your Path to <span className="text-[#E46A52]">Homeownership</span>
            </h2>
            <p className="text-gray-500 mt-2 max-w-2xl mx-auto text-sm sm:text-base">
          ...
          <div className="relative">
            {/* Timeline line */}
            <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-1 bg-[#E46A52]/20 transform -translate-x-1/2 hidden md:block" />
              ...
              {steps.map((step, index) => (
                ...
                >
                  ...
                  <div className="absolute left-4 md:left-1/2 top-6 md:top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 hidden md:flex">
                    <div className="w-5 h-5 lg:w-6 lg:h-6 rounded-full bg-[#E46A52] border-4 border-white shadow-lg flex items-center justify-center">
                  ...
                  <div className="md:hidden absolute left-3 top-5 transform -translate-x-1/2 z-10">
                    <div className="w-4 h-4 rounded-full bg-[#E46A52] border-2 border-white shadow" />
                  </div>
                  ...
                  >
                    <div className="bg-white p-4 sm:p-5 lg:p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                      ...
                      >
                        <div className="w-10 h-10 lg:w-12 lg:h-12 rounded-xl bg-[#E46A52]/10 text-[#E46A52] flex items-center justify-center flex-shrink-0">
                          {step.icon}
                        </div>
                        <div>
                          <span className="text-xs font-semibold text-[#E46A52]">
                            Step {index + 1}
                          </span>
      ...
      {/* Detailed Sections - unchanged */}
      <section className="py-12 sm:py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-gray-800">
              Understanding the{" "}
              <span className="text-[#E46A52]">Loan Process</span>
            </h2>
          ...
          <div className="space-y-6 sm:space-y-8">
            {sections.map((section, index) => (
              <div
                key={index}
                className="bg-gray-50 rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow"
              >
                <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-6 border-b border-gray-100 bg-white/50">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-[#E46A52]/10 text-[#E46A52] flex items-center justify-center flex-shrink-0 mt-0.5">
                    {section.icon}
                  </div>
                  <div>
      ...
      {/* Credit Score Section - unchanged */}
      <section className="py-12 sm:py-16 md:py-24 bg-[#E46A52]/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="order-2 md:order-1">
              <div className="inline-flex items-center gap-2 bg-[#E46A52]/10 text-[#E46A52] px-3 py-1.5 rounded-full text-xs font-semibold mb-3 sm:mb-4">
                <Scale className="w-4 h-4" />
                Credit Scores Explained
              </div>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-gray-800 mb-3 sm:mb-4">
                Understanding Your{" "}
                <span className="text-[#E46A52]">Credit Score</span>
              </h2>
            ...
            <div className="order-1 md:order-2">
              <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-6 md:p-8 border border-gray-100">
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div>
                    <div className="flex justify-between text-xs sm:text-sm mb-1">
                      ...
                      <span className="text-[#E46A52] font-bold">740+</span>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between text-xs sm:text-sm mb-1">
                      ...
                      <span className="text-[#E46A52] font-bold">670–739</span>
                    </div>
                    <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
                      <div
                  ...
                  <div>
                    <div className="flex justify-between text-xs sm:text-sm mb-1">
                      ...
                      <span className="text-[#E46A52] font-bold">580–669</span>
                    </div>
                    <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
                      <div
                  ...
                  <div>
                    <div className="flex justify-between text-xs sm:text-sm mb-1">
                      ...
                      <span className="text-[#E46A52] font-bold">
                        Below 580
                      </span>
                    </div>
                    <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
                ...
                <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-[#E46A52]/5 rounded-xl">
                  <p className="text-xs sm:text-sm text-gray-600">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 max-w-3xl mx-auto">
            {timelineItems.map((item, index) => (
              ...
              >
                <div className="text-[#E46A52] text-xl sm:text-2xl font-bold">
                  {item.days}
                </div>
          ...
          <div className="mt-6 sm:mt-8 p-4 sm:p-6 bg-[#E46A52]/5 rounded-2xl border border-[#E46A52]/10">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4 mt-4 sm:mt-4">
              <Link
                href="/apply"
                className="inline-flex items-center justify-center gap-2 bg-[#E46A52] text-white px-5 py-2.5 sm:px-6 sm:py-3 rounded-xl font-semibold hover:bg-[#d95a42] transition-transform hover:-translate-y-1 shadow-lg text-sm sm:text-base"
              >
                Apply Online
                <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5" />
              </Link>
              <Link
                href="/contact"
                className="inline-flex items-center justify-center gap-2 bg-white text-[#E46A52] px-5 py-2.5 sm:px-6 sm:py-3 rounded-xl font-semibold border border-[#E46A52]/30 hover:bg-gray-50 transition-transform hover:-translate-y-1 text-sm sm:text-base"
              >
                <Phone className="w-4 h-4 sm:w-5 sm:h-5" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4">
              <Link
                href="/about"
                className="inline-flex items-center justify-center gap-2 bg-white text-[#E46A52] px-6 py-3 sm:px-8 sm:py-4 rounded-xl font-bold hover:bg-gray-100 transition-transform hover:-translate-y-1 shadow-xl text-sm sm:text-base"
              >
                Apply Now
                <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5" />
              </Link>
