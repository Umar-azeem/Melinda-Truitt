...
const loanOfficersData = [
  {
    name: "Nicole Alamrew",
    title: "Branch Loan Processor",
    nmls: "1172554",
    office: "",
    cell: "(972) 807-3350",
    email: "nicole@mcmtg.com",
  },
  {
    name: "Ryan Blomberg",
    title: "Loan Officer",
  ...
  },
  {
    ...
    office: "(253) 200-3255",
    cell: "(253) 222-0740",
    email: "Hciccia@futurefirstmtg.com",
  },
  {
  ...
  },
  {
    ...
    office: "",
    cell: "(802) 380-4866",
    email: "dfreeman@cfmtg.com",
  },
  {
    name: "Nauris Tankevicius",
    title: "Branch Manager",
    nmls: "227831",
    office: "",
    cell: "(312) 498-3753",
    email: "Nauris@cfmtg.com",
  },
  {
    name: "Ethan Wilson",
    ...
    office: "(253) 200-3255",
    cell: "(408) 449-9703",
    email: "EthanW@futurefirstmtg.com",
  },
  {
    name: "Colby Rae Campbell",
    title: "Loan Officer",
    nmls: "1705632",
    office: "",
    cell: "(814) 771-6012",
    email: "colby@atlasmortgagegrp.com",
  },
  {
    name: "Matt Webber",
    title: "Branch Manager",
  ...
  },
  {
    ...
    office: "",
    cell: "949-702-0532",
    email: "jtolman@cfmtg.com",
  },
  {
    name: "Jeremy Fenstermaker",
    title: "Loan Officer",
    nmls: "625915",
    office: "",
    cell: "(480) 433-0955",
    email: "jeremy@cfmtg.com",
  },
  {
    name: "Silvana Fertig",
    title: "Loan Officer",
  ...
  },
  {
    ...
    office: "",
    cell: "(407) 617-3749",
    email: "Rubens.Vaz@lendufinance.us",
  },
  {
    name: "Mercia Sousa",
    title: "Loan Officer",
  ...
  },
  {
    ...
    office: "",
    cell: "(561) 578-9249",
    email: "slane@moderndaylending.com",
  },
  {
    name: "Chris Nooney",
    title: "Area Manager",
  ...
  },
  {
    ...
    office: "",
    cell: "(516) 477-1194",
    email: "lbaker@moderndaylending.com",
  },
  {
    name: "Richard Terzo",
    title: "Loan Officer",
  ...
  },
  {
    ...
    office: "",
    cell: "(210) 912-9588",
    email: "kcline@mcmtg.com",
  },
  {
    name: "Jessica Rose Elliott",
    title: "Loan Officer",
    nmls: "2508656",
    office: "(205) 471-7787",
    cell: "(404) 831-8235",
    email: "jelliott@cfmtg.com",
  },
  {
  ...
  },
  {
    ...
    office: "",
    cell: "(330) 592-9080",
    email: "Beth.Johnson@armormortgage.com",
  },
  {
    name: "Tom Schwab",
    title: "Branch Manager",
  ...
  },
  {
    ...
    office: "",
    cell: "(630) 802-4433",
    email: "bbenton@cfmtg.com",
  },
  {
    name: "Adam Jaroszewski",
    title: "Loan Officer",
    nmls: "1192000",
    office: "",
    cell: "(954) 348-5157",
    email: "Adamj@cfmtg.com",
  },
  {
    name: "Steve Layne",
    ...
    office: "",
    cell: "(734) 363-1594",
    email: "slayne@youfihomeloans.com",
  },
  {
    name: "AJ Frandanisa",
    title: "Loan Officer",
    ...
    office: "(253) 200-3255",
    cell: "(253) 439-7357",
    email: "AnthonyF@futurefirstmtg.com",
  },
  {
    name: "Rhett Grant",
    title: "Loan Officer",
  ...
  },
  {
    ...
    office: "",
    cell: "(702) 902-6917",
    email: "lmokeski@cfmtg.com",
  },
  {
    name: "Kendall Stevens",
    title: "Sr. Loan Officer",
    nmls: "2384354",
    office: "",
    cell: "(864) 529-7422",
    email: "KStevens@cfmtg.com",
  },
  {
  ...
  },
  {
    ...
    office: "",
    cell: "(786) 356-9508",
    email: "jorge@constantlending.net",
  },
  {
    name: "Ruben Romero",
    title: "Branch Manager",
  ...
  {
    name: "Robbie Ballance",
    title: "Senior Mortgage Advisor",
    nmls: "70392",
    office: "",
    cell: "(919) 524-6651",
    email: "RBallance@cfmtg.com",
  },
  {
    name: "Jason Grubba",
  ...
  {
    name: "Cathy Lilly",
    title: "Senior Reverse Mortgage Advisor",
    nmls: "475808",
    office: "",
    cell: "(951) 385-9517",
    email: "cathy@cfmtg.com",
  },
  {
    name: "Constantino Bovino",
    title: "Branch Manager",
    nmls: "1276236",
    office: "",
    cell: "(908) 303-9171",
    email: "CBovino@cfmtg.com",
  },
  {
    name: "Steve Deeds",
    title: "Loan Officer",
  ...
  },
  {
    ...
    office: "",
    cell: "(312) 799-9375",
    email: "TColburn@cfmtg.com",
  },
];

const uniqueRoles = Array.from(
  new Set(loanOfficersData.map((b) => b.title)),
).sort();
...
export default function Find() {
  ...
  const filtered = useMemo(() => {
    ...
    return loanOfficersData.filter((b) => {
      ...
      const matchFilter =
        activeFilters.length === 0 || activeFilters.includes(b.title);
    ...
    <div className="bg-[#f5f5f5] min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-gray-900">
                  {loanOfficersData.length}+
                </p>
                <p className="text-sm text-gray-600">Loan Officers</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="bg-[#E46A52] p-2 rounded-full">
              ...
              <div>
                <p className="text-2xl font-bold text-gray-900">Nationwide</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Contact Access</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <button
                ...
                className={`px-3 py-1 text-xs rounded-full border transition ${
                  activeFilters.includes(role)
                    ? "bg-[#E46A52] text-white border-[#E46A52]"
                    : "bg-white text-gray-600 border-gray-300 hover:border-[#E46A52]"
                }`}
              >
                {role}
              </button>
              ...
              <div className="flex-1 min-w-0 pt-1">
                ...
                <div className="flex gap-2 mt-3">
                  <a
                    ...
                    className="inline-flex items-center gap-1 px-3 py-1.5 text-xs font-medium text-white bg-[#E46A52] rounded-lg hover:bg-[#004a25] transition"
                  >
                  ...
                  {officer.cell && (
                    <a
                      ...
                      className="inline-flex items-center gap-1 px-3 py-1.5 text-xs font-medium text-[#E46A52] bg-green-50 rounded-lg hover:bg-green-100 transition"
                    >
        ...
        <div className="mt-12 bg-[#E46A52] rounded-2xl p-8 text-white text-center">
          ...
          >
            <Phone className="w-5 h-5" /> (469) 480-4699
          </a>
        </div>

        <div className="mt-8 p-4 bg-gray-50 rounded-lg border border-gray-200">
          <p className="text-xs text-gray-500 text-center leading-relaxed">
            All loan officers are licensed mortgage professionals. Loan
