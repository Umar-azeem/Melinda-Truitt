...
const MortgageLandingPage = () => {
  const icons = {
    ...
    x: "https://img.icons8.com/ios-filled/50/374151/x.png", // Twitter/X icon
  };
        ...
        <main className="relative z-10 max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center px-4 sm:px-6 lg:px-8 pt-18 pb-20 gap-10">
          <div className="flex-1  max-w-2xl w-full text-center lg:text-left">
            ...
            <p className="text-sm sm:text-base text-gray-200 mb-10 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              ...
              market conditions and mortgage programs change frequently, you
              need to make sure you{`'`}re dealing with a top professional who is
              able to give you quick and accurate financial advice. I have the
              expertise and knowledge you need to explore the many financing
              options available.
            </p>
          ...
          <div className="flex-1 relative flex justify-center lg:justify-end items-end w-full">
            ...
            <div className="  relative w-full max-w-[450px]">
              ...
              <div className="absolute -bottom-6 sm:bottom-1 right-0 md:right-22 left-0 sm:left-auto mx-auto sm:mx-0 bg-white text-gray-900 p-3 sm:p-2 rounded-2xl shadow-2xl w-[80%] sm:w-62">
                <h3 className="text-xl font-bold mb-2">Melinda Truitt</h3>
                <p className="text-gray-600 text-sm mb-1">
                  Senior Loan Officer
                </p>
                <p className="text-gray-500 text-xs mb-1">NMLS ID: 399001</p>
                <div className="flex items-center gap-3 w-full">
                  <a
                    href="https://www.facebook.com/226240744134830"
                    className="w-9 h-9 md:w-10 md:h-10 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition"
                  >
                    <Icon
                      src={icons.facebook}
                      size={18}
                  ...
                  <a
                    href="https://www.linkedin.com/in/melinda-truitt-025baa2"
                    className="w-9 h-9 md:w-10 md:h-10 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition"
                  >
                    <Icon src={icons.linkedin} size={18} />
                  </a>
                  <a
                    href="https://x.com/MelindaTruitt10"
                    className="w-9 h-9 md:w-10 md:h-10 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition"
                  >
                    <Icon src={icons.x} size={18} />
                  </a>
                  <a
